...
const veloraPackageCatalog = <String, VeloraPackageInstall>{
  ...
  'velora_db': VeloraPackageInstall(
    ...
    notes: [
      ...
      'NATIVE (iOS/Android/macOS/Windows/Linux): nothing to set up -- sqlite3_flutter_libs comes in transitively with velora_db and bundles native SQLite into your build automatically.',
      'WEB: drift needs two static assets alongside your app -- sqlite3.wasm and drift_worker.js. See docs/packages/db.md\'s Cross-platform section for where to get them and where to put them.',
